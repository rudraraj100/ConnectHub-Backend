...
public class OAuth2AuthenticationSuccessHandler
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        // Suspended users must NOT receive a JWT via OAuth2 either.
        // Without this check they can bypass suspension entirely via Google login.
        if (!user.isActive()) {
            log.warn("[OAuth2] Blocked suspended user {} from OAuth2 login", user.getEmail());
