...
/**
 * Global exception handler — converts runtime exceptions to clean
 * ApiResponse<Void> error envelopes with appropriate HTTP status codes.
 */
@Slf4j
@RestControllerAdvice(basePackages = "com.auth_service")
