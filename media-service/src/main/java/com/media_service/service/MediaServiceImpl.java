...
public class MediaServiceImpl implements MediaService {
    ...
    /** Subdirectory name used for image thumbnails — defined once to avoid duplication. */
    private static final String THUMBS = "thumbs";

    /** URL path prefix used when building view URLs for locally stored media files. */
    @Value("${app.media.view-path:/media/view/}")
    private String mediaViewPath;
        ...
        try {
            ...
            if (img != null) {
                ...
                if (s3Client.isPresent()) {
                    ...
                    mediaFile.setThumbnailUrl(baseUrl + mediaViewPath + THUMBS + "/" + thumbFileName);
                }
            }
        } catch (Exception e) {
    ...
    private String uploadBytesToLocal(byte[] bytes, String fileName) throws IOException {
        ...
        return baseUrl + mediaViewPath + fileName;
    }
